...
tampermonkeyConfig = tampermonkeyConfig.replace('__APP_RELEASE_VERSION__', buildMeta.releaseVersion)
tampermonkeyConfig = tampermonkeyConfig.replace('__APP_BUILD_ID__', buildMeta.buildId)
...
console.log(`build complete! ${buildMeta.releaseVersion}`)
